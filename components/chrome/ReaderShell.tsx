 ...
 *
 * A client component wrapping server-rendered children, so /about and /faqs
 * keep their copy in the HTML for crawlers while still getting the light/dark
 * switch and the scroll chrome. The blog does not use it: its board owns state
 * that the shell would have to thread through, so it composes the same hooks
 * directly instead.
 *
